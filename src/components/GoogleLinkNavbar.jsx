...
function GoogleApps(props) {
  ...
  return (
    <div className="absolute cursor-auto h-96 overflow-y-scroll overflow-x-hidden w-96 z-50 right-0 bg-gray-900 rounded-3xl border-[10px] border-gray-800">
      <div className="grid gap-4 grid-cols-3 p-10">
        {appIcons.map((iconObj) => {
          ...
          return (
            <div
              key={name}
              className="flex cursor-pointer flex-col items-center hover:bg-slate-800 p-6 rounded-3xl">
  ...
  return (
    <div
      ...
      <div className="flex justify-center">
        <span className="flex ">keshav01juneja@gmail.com</span>
        {/* close button */}
        <svg
          x="0px"
          y="0px"
      ...
      <div className="text-2xl flex justify-center">Hi,Keshav!</div>
      <button className="text-lg flex justify-center w-full max-w-lg text-blue-200 border-2 border-gray-500 rounded-full mt-2">
        Manage your Google Account
      </button>
      <div className="flex justify-center gap-2 items-center mt-16 text-sm ">
